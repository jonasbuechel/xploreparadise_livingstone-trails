  ...
  textContent: {
    ...
    work: {
      ...
      text: [
        ...
        {
          content: 'Share the pictures and videos with your friends and become a part of this incredible adventure.'
        }
      ]
    },
    about: {
      ...
      text: [
        {
          content:'As a young boy, Christoph Tänzer began his deep love of exploration, adventure and nature, dreaming about foreign countries, intriguing places and different cultures. More than 30 years later, these dreams came true for the German creative director, photographer and filmmaker. His passion developed into an idea: Winning people’s understanding through photography and film to protect our planet.'
        }
      ],
      text2: [
        {
    ...
    copyright: {
      text:[
        {
          content: 'COPYRIGHT © 2016 CHRISTOPH TÄNZER. ALL RIGHTS RESERVED.'
        }
      ]
    }
  }
