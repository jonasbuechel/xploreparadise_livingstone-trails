...
export default Ember.Mixin.create({
  ...
  mainGalleryItems: Ember.computed(function() {
    ...
    const imageObjects = [
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/05_xploreparadise_tlt.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/05_xploreparadise_tlt.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/06_xploreparadise_tlt.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/06_xploreparadise_tlt.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/07_xploreparadise_tlt.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/07_xploreparadise_tlt.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/12_xploreparadise_tlt.jpg' ,
          src:    config.rootURL + 'assets/mainGallery/fullsize/12_xploreparadise_tlt.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/16_xploreparadise_tlt.jpg',
          src:    config.rootURL + 'assets/mainGallery/fullsize/16_xploreparadise_tlt.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/17_xploreparadise_tlt.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/17_xploreparadise_tlt.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/18_xploreparadise_tlt_fb.jpg',
          src:    config.rootURL + 'assets/mainGallery/fullsize/18_xploreparadise_tlt_fb.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/20_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/20_xploreparadise_tlt_fb.jpg', 
          title:  'If you think it’s easy to spot big cats in the bush, think again! They blend perfectly into their environment. Spotting a cat takes a lot practice and knowledge of their behaviour.'
           ...
           {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/21_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/21_xploreparadise_tlt_fb.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/23_xploreparadise_tlt_fb.jpg',
          src:    config.rootURL + 'assets/mainGallery/fullsize/23_xploreparadise_tlt_fb.jpg',
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/24_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/24_xploreparadise_tlt_fb.jpg',
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/25_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/25_xploreparadise_tlt_fb.jpg',
          title:  'Observing jackals is very interesting, but it requires a lot of patience. They are very shy, and always on the alert. The slightest movement can scare them away. We observed this jackal drinking at a watering hole for about an hour. He made his way cautiously to the water, constantly changing his direction.'
           ...
           {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/26_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/26_xploreparadise_tlt_fb.jpg',
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/32_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/32_xploreparadise_tlt_fb.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/33_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/33_xploreparadise_tlt_fb.jpg', 
          title:  'An hour before sunset, elephants and giraffes came to the watering hole. The elephants took mud baths and dust showers. I stayed at the watering hole for two hours, and was able to capture this beautiful contre-jour shot of a bull elephant walking in front of the setting sun.'
                ...
                {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/43_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/43_xploreparadise_tlt_fb.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/46_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/46_xploreparadise_tlt_fb.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/53_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/53_xploreparadise_tlt_fb.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/54_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/54_xploreparadise_tlt_fb.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/55_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/55_xploreparadise_tlt_fb.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/56_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/56_xploreparadise_tlt_fb.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/58_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/58_xploreparadise_tlt_fb.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/60_xploreparadise_tlt_fb.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/60_xploreparadise_tlt_fb.jpg', 
        ...
        {
          msrc:   config.rootURL + 'assets/mainGallery/thumbnails/61_xploreparadise_tlt.jpg', 
          src:    config.rootURL + 'assets/mainGallery/fullsize/61_xploreparadise_tlt.jpg', 
